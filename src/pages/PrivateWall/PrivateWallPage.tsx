...
import styles from '../PublicWall/PublicWallPage.module.css';
...
const PrivateWallPage: React.FC = () => {
    ...
    const fetchCapsules = async () => {
        try {
          const response = await api.get('/private/revealed');
    ...
    const fetchUpcomingCapsules = async () => {
        try {
          const response = await api.get('/private/upcoming');
            ...
            <main className={styles.main}>
                <div className={styles.header}>
                    <div className={styles.titleSection}>
                        <h1 className={styles.pageTitle}>Your Time Capsules</h1>
                        <p className={styles.pageSubtitle}>These are the memories you’ve created</p>
                    </div>
                    <button 
...
export default PrivateWallPage;